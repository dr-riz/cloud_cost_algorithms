...
public class AdaptiveGreedy extends Algorithm {
	...
	AdaptiveGreedy(double ar, TransactionClass tc,
			int useCase) {
		super(ar, tc, useCase);
		m_name = "adaptiveGreedy";
		// TODO Auto-generated constructor stub
	}

	AdaptiveGreedy(Vector<TransactionClass> tcs, Vector<Partition> dps, int useCase) {
	...
	public void calcCostOf_new_conf() {
		...
		printStep("adaptiveGreedy", m_scenario, m_confp, m_minimumCost,
				m_numMinima);
	}
